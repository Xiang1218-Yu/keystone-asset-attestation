...
func NewServiceModule() Module {
	return ServiceModule{key: "service", priority: 32, family: "asset", focus: "service visit records"}
}

func (m ServiceModule) Key() string {
	return m.key
}

func (m ServiceModule) Description() string {
	return m.focus
}

func (m ServiceModule) Priority() int {
	return m.priority
}

func (m ServiceModule) Family() string {
	return m.family
}

func (m ServiceModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m ServiceModule) Validate(input string) error {
...
func (m ServiceModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ServiceModule) Transition(stage string) bool {
...
func (m ServiceModule) Evidence(input string, now time.Time) Evidence {
...
func (m ServiceModule) Score(input string) int {
	value := strings.TrimSpace(input)
