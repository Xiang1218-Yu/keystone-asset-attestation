...
func NewLocationModule() Module {
	return LocationModule{key: "location", priority: 15, family: "asset", focus: "facility location references"}
}

func (m LocationModule) Key() string {
	return m.key
}

func (m LocationModule) Description() string {
	return m.focus
}

func (m LocationModule) Priority() int {
	return m.priority
}

func (m LocationModule) Family() string {
	return m.family
}

func (m LocationModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m LocationModule) Validate(input string) error {
...
func (m LocationModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m LocationModule) Transition(stage string) bool {
...
func (m LocationModule) Evidence(input string, now time.Time) Evidence {
...
func (m LocationModule) Score(input string) int {
	value := strings.TrimSpace(input)
