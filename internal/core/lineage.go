...
func NewLineageModule() Module {
	return LineageModule{key: "lineage", priority: 3, family: "asset", focus: "multi-level provenance relationships"}
}

func (m LineageModule) Key() string {
	return m.key
}

func (m LineageModule) Description() string {
	return m.focus
}

func (m LineageModule) Priority() int {
	return m.priority
}

func (m LineageModule) Family() string {
	return m.family
}

func (m LineageModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m LineageModule) Validate(input string) error {
...
func (m LineageModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m LineageModule) Transition(stage string) bool {
...
func (m LineageModule) Evidence(input string, now time.Time) Evidence {
...
func (m LineageModule) Score(input string) int {
	value := strings.TrimSpace(input)
