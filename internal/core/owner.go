...
func NewOwnerModule() Module {
	return OwnerModule{key: "owner", priority: 54, family: "asset", focus: "accountable ownership resolution"}
}

func (m OwnerModule) Key() string {
	return m.key
}

func (m OwnerModule) Description() string {
	return m.focus
}

func (m OwnerModule) Priority() int {
	return m.priority
}

func (m OwnerModule) Family() string {
	return m.family
}

func (m OwnerModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m OwnerModule) Validate(input string) error {
...
func (m OwnerModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m OwnerModule) Transition(stage string) bool {
...
func (m OwnerModule) Evidence(input string, now time.Time) Evidence {
...
func (m OwnerModule) Score(input string) int {
	value := strings.TrimSpace(input)
