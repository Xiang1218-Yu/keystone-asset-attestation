...
func NewSealModule() Module {
	return SealModule{key: "seal", priority: 42, family: "asset", focus: "immutable sealing transition"}
}

func (m SealModule) Key() string {
	return m.key
}

func (m SealModule) Description() string {
	return m.focus
}

func (m SealModule) Priority() int {
	return m.priority
}

func (m SealModule) Family() string {
	return m.family
}

func (m SealModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m SealModule) Validate(input string) error {
...
func (m SealModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m SealModule) Transition(stage string) bool {
...
func (m SealModule) Evidence(input string, now time.Time) Evidence {
...
func (m SealModule) Score(input string) int {
	value := strings.TrimSpace(input)
