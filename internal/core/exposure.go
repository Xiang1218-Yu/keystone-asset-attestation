...
func NewExposureModule() Module {
	return ExposureModule{key: "exposure", priority: 59, family: "asset", focus: "exposure window analysis"}
}

func (m ExposureModule) Key() string {
	return m.key
}

func (m ExposureModule) Description() string {
	return m.focus
}

func (m ExposureModule) Priority() int {
	return m.priority
}

func (m ExposureModule) Family() string {
	return m.family
}

func (m ExposureModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m ExposureModule) Validate(input string) error {
...
func (m ExposureModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ExposureModule) Transition(stage string) bool {
...
func (m ExposureModule) Evidence(input string, now time.Time) Evidence {
...
func (m ExposureModule) Score(input string) int {
	value := strings.TrimSpace(input)
