...
func NewAssetModule() Module {
	return AssetModule{key: "asset", priority: 1, family: "asset", focus: "asset identity and lifecycle"}
}

func (m AssetModule) Key() string {
	return m.key
}

func (m AssetModule) Description() string {
	return m.focus
}

func (m AssetModule) Priority() int {
	return m.priority
}

func (m AssetModule) Family() string {
	return m.family
}

func (m AssetModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m AssetModule) Validate(input string) error {
...
func (m AssetModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m AssetModule) Transition(stage string) bool {
...
func (m AssetModule) Evidence(input string, now time.Time) Evidence {
...
func (m AssetModule) Score(input string) int {
	value := strings.TrimSpace(input)
