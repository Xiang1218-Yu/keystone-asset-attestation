...
func NewOperatorModule() Module {
	return OperatorModule{key: "operator", priority: 55, family: "asset", focus: "operator qualification checks"}
}

func (m OperatorModule) Key() string {
	return m.key
}

func (m OperatorModule) Description() string {
	return m.focus
}

func (m OperatorModule) Priority() int {
	return m.priority
}

func (m OperatorModule) Family() string {
	return m.family
}

func (m OperatorModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m OperatorModule) Validate(input string) error {
...
func (m OperatorModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m OperatorModule) Transition(stage string) bool {
...
func (m OperatorModule) Evidence(input string, now time.Time) Evidence {
...
func (m OperatorModule) Score(input string) int {
	value := strings.TrimSpace(input)
