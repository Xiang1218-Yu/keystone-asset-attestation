...
func NewContractModule() Module {
	return ContractModule{key: "contract", priority: 46, family: "asset", focus: "supplier contract obligations"}
}

func (m ContractModule) Key() string {
	return m.key
}
...
func (m ContractModule) Priority() int {
	return m.priority
}

func (m ContractModule) Family() string {
	return m.family
}

func (m ContractModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m ContractModule) Validate(input string) error {
...
func (m ContractModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ContractModule) Transition(stage string) bool {
...
func (m ContractModule) Evidence(input string, now time.Time) Evidence {
...
func (m ContractModule) Score(input string) int {
	value := strings.TrimSpace(input)
