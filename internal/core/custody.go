...
func NewCustodyModule() Module {
	return CustodyModule{key: "custody", priority: 16, family: "asset", focus: "custody transfer checkpoints"}
}

func (m CustodyModule) Key() string {
	return m.key
}

func (m CustodyModule) Description() string {
	return m.focus
}

func (m CustodyModule) Priority() int {
	return m.priority
}

func (m CustodyModule) Family() string {
	return m.family
}

func (m CustodyModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m CustodyModule) Validate(input string) error {
...
func (m CustodyModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m CustodyModule) Transition(stage string) bool {
...
func (m CustodyModule) Evidence(input string, now time.Time) Evidence {
...
func (m CustodyModule) Score(input string) int {
	value := strings.TrimSpace(input)
