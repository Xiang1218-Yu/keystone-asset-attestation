...
func NewNotificationModule() Module {
	return NotificationModule{key: "notification", priority: 56, family: "asset", focus: "notification escalation paths"}
}

func (m NotificationModule) Key() string {
	return m.key
}
...
func (m NotificationModule) Family() string {
	return m.family
}

func (m NotificationModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m NotificationModule) Validate(input string) error {
...
func (m NotificationModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m NotificationModule) Transition(stage string) bool {
...
func (m NotificationModule) Evidence(input string, now time.Time) Evidence {
...
func (m NotificationModule) Score(input string) int {
	value := strings.TrimSpace(input)
