...
func NewZoneModule() Module {
	return ZoneModule{key: "zone", priority: 51, family: "asset", focus: "zone exposure boundaries"}
}

func (m ZoneModule) Key() string {
	return m.key
}

func (m ZoneModule) Description() string {
	return m.focus
}

func (m ZoneModule) Priority() int {
	return m.priority
}

func (m ZoneModule) Family() string {
	return m.family
}

func (m ZoneModule) Enabled() bool {
	return m.priority > 0 && strings.TrimSpace(m.key) != ""
}

func (m ZoneModule) Validate(input string) error {
...
func (m ZoneModule) Rewrite(input string) string {
	value := strings.TrimSpace(input)
...
func (m ZoneModule) Transition(stage string) bool {
...
func (m ZoneModule) Evidence(input string, now time.Time) Evidence {
...
func (m ZoneModule) Score(input string) int {
	value := strings.TrimSpace(input)
